...
<div style="width: inherit;height: 980px;">
    ...
    <div  class="move">
        ...
        <form action="/sc/point" name="baseForm" style="color: white">
            Node节点地址：<input type="text" placeholder="默认:127.0.0.1" name="nodeHost" ><br><br>
            Node端口：<input type="text" placeholder="默认：7051" name="nodePort" ><br><br>
            Consenter节点地址：<input type="text" placeholder="默认：127.0.0.1" name="consenterHost" ><br><br>
            Consenter端口：<input type="text" placeholder="默认：7050" name="consenterPort" ><br><br>
